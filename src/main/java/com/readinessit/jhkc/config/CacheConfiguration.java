package com.readinessit.jhkc.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhipsterkeycloack");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhipsterkeycloack");
        ...
        config.getMapConfigs().put("com.readinessit.jhkc.domain.*", initializeDomainMapConfig(jHipsterProperties));
